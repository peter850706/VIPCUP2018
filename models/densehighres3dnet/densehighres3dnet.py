...
class DenseHighRes3DNet(BaseNet):
    def __init__(self,
        ...
        [{'name': 'conv_00', 'n_features': 8, 'kernel_size': 3},
         ...
         {'name': 'conv_07', 'n_features': num_classes, 'kernel_size': 1},        
    ...
    def layer_op(self, images, is_training=True, layer_id=-1, **unused_kwargs):
        ...
        flow = tf.concat([lateral_flow0, lateral_flow1, lateral_flow2, flow], axis=-1)
        ...
        flow = duc_layer(flow, r=params8['upsampling_rate'])
        layer_instances.append((duc_layer, flow))
